...
privileged aspect QuestionBean_Roo_ManagedBean {
    ...
    private Question QuestionBean.question;
    
    private List<Question> QuestionBean.allQuestions;
    
    private boolean QuestionBean.dataVisible = false;
    
    private List<String> QuestionBean.columns;
    ...
    public String QuestionBean.findAllQuestions() {
        allQuestions = Question.findAllQuestions();
    ...
    public HtmlPanelGrid QuestionBean.populateCreatePanel() {
        ...
        visitorCreateInput.setValueExpression("itemLabel", expressionFactory.createValueExpression(elContext, "#{visitor.nickname} #{visitor.email} #{visitor.ipAddress} #{visitor.createdAt}", String.class));
    ...
    public HtmlPanelGrid QuestionBean.populateEditPanel() {
        FacesContext facesContext = FacesContext.getCurrentInstance();
        Application application = facesContext.getApplication();
        ExpressionFactory expressionFactory = application.getExpressionFactory();
        ELContext elContext = facesContext.getELContext();
        ...
        HtmlOutputText answersEditInput = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
        answersEditInput.setId("answersEditInput");
        answersEditInput.setValue("This relationship is managed from the Answer side");
        ...
        visitorEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.visitor}", Visitor.class));
        visitorEditInput.setCompleteMethod(expressionFactory.createMethodExpression(elContext, "#{questionBean.completeVisitor}", List.class, new Class[] { String.class }));
        ...
        visitorEditInput.setValueExpression("itemLabel", expressionFactory.createValueExpression(elContext, "#{visitor.nickname} #{visitor.email} #{visitor.ipAddress} #{visitor.createdAt}", String.class));
        ...
        titleEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.title}", String.class));
        ...
        createdAtEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.createdAt}", Date.class));
        ...
        updatedAtEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.updatedAt}", Date.class));
        ...
        InputText bodyEditInput = (InputText) application.createComponent(InputText.COMPONENT_TYPE);
        bodyEditInput.setId("bodyEditInput");
        bodyEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.body}", String.class));
        ...
        HtmlOutputText visibleEditOutput = (HtmlOutputText) application.createComponent(HtmlOutputText.COMPONENT_TYPE);
        visibleEditOutput.setId("visibleEditOutput");
        visibleEditOutput.setValue("Visible:   ");
        htmlPanelGrid.getChildren().add(visibleEditOutput);
        
        SelectBooleanCheckbox visibleEditInput = (SelectBooleanCheckbox) application.createComponent(SelectBooleanCheckbox.COMPONENT_TYPE);
        visibleEditInput.setId("visibleEditInput");
        visibleEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.visible}", Boolean.class));
        visibleEditInput.setRequired(false);
        htmlPanelGrid.getChildren().add(visibleEditInput);
        
        Message visibleEditInputMessage = (Message) application.createComponent(Message.COMPONENT_TYPE);
        visibleEditInputMessage.setId("visibleEditInputMessage");
        visibleEditInputMessage.setFor("visibleEditInput");
        visibleEditInputMessage.setDisplay("icon");
        htmlPanelGrid.getChildren().add(visibleEditInputMessage);
        ...
        SelectBooleanCheckbox emailAnswerEditInput = (SelectBooleanCheckbox) application.createComponent(SelectBooleanCheckbox.COMPONENT_TYPE);
        emailAnswerEditInput.setId("emailAnswerEditInput");
        emailAnswerEditInput.setValueExpression("value", expressionFactory.createValueExpression(elContext, "#{questionBean.question.emailAnswer}", Boolean.class));
    ...
    public List<Visitor> QuestionBean.completeVisitor(String query) {
        ...
        for (Visitor visitor : Visitor.findAllVisitors()) {
            String visitorStr = String.valueOf(visitor.getNickname() +  " "  + visitor.getEmail() +  " "  + visitor.getIpAddress() +  " "  + visitor.getCreatedAt());
    ...
    public String QuestionBean.persist() {
        String message = "";
